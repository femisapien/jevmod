...
| C38 | / | /mod forget deletes everything, and so does kicking the bot. | jevmod/adapters/discord_bot.py:324; jevmod/adapters/discord_bot.py:187 | delete_tenant; forget everything | yes |
