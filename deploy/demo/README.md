...
Deployed 2026-09-18 on Omar's Hetzner box as `jevmod-demo` + `jevmod-site` (host `jevmod.dev` (old host jevmod.hernandezbastos.es redirects), its own TypeSafe key).
